...
| Lecture 3  | 03/10/2020 | Apache Spark + PySpark Tutorial (I part) | [slides: <a href="./slides/03_Spark.pdf" target="_blank">PDF</a>, Colab notebook: <a href="./notebooks/03_PySpark_Tutorial.ipynb" target="_blank">ipynb</a>] |
| Lecture 4  | 03/11/2020 | PySpark Tutorial (II part) + Clustering: Data Representation | [slides: <a href="./slides/04_Clustering.pdf" target="_blank">PDF</a>, Colab notebook: <a href="./notebooks/04_The_Curse_Of_Dimensionality.ipynb" target="_blank">ipynb</a>] |
...
| Lecture 7  | 03/24/2020 | Document Clustering with PySpark | [Colab notebook: <a href="./notebooks/07_Document_Clustering.ipynb" target="_blank">ipynb</a>] |
