...
| Lecture 3  | 03/10/2020 | Apache Spark + PySpark Tutorial | [slides: <a href="./slides/03_Spark.pdf" target="_blank">PDF</a>, notebook: <a href="./notebooks/03_PySpark_Tutorial.ipynb" target="_blank">ipynb</a>] |
